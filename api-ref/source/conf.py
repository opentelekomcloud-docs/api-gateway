...
project = 'API Gateway (APIG)'
otcdocs_repo_name = 'opentelekomcloud-docs/api-gateway'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/api-gateway/api-ref/'
...
html_title = "API Gateway (APIG) - API Reference"
...
latex_documents = [
    ('index',
     'apig-api-ref.tex',
     u'API Gateway (APIG) - API Reference',
